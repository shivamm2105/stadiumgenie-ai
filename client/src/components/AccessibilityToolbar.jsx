        ...
        <GlassCard className="absolute bottom-16 right-0 w-72 border border-slate-300 dark:border-white/20 shadow-2xl p-4">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-base font-bold flex items-center gap-2 dark:text-white">
              <Accessibility className="w-5 h-5 text-fifa-emerald" /> Accessibility Suite
            </h3>
            <button
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              <label htmlFor="toggle-contrast" className="text-sm font-medium flex items-center gap-2 dark:text-slate-200">
                <Eye className="w-4 h-4 text-fifa-blue" /> High Contrast
              </label>
              <input
                id="toggle-contrast"
                type="checkbox"
                ...
                className="w-9 h-5 bg-gray-200 rounded-full appearance-none checked:bg-fifa-emerald relative before:content-[''] before:absolute before:h-4 before:w-4 before:bg-white before:rounded-full before:top-[2px] before:left-[2px] checked:before:translate-x-4 before:transition-transform cursor-pointer"
              />
            </div>
            ...
            <div className="flex justify-between items-center">
              <label htmlFor="toggle-text" className="text-sm font-medium flex items-center gap-2 dark:text-slate-200">
                <Type className="w-4 h-4 text-fifa-blue" /> Large Text (120%)
              </label>
              <input
                id="toggle-text"
                type="checkbox"
            ...
            <div className="flex justify-between items-center">
              <label htmlFor="toggle-dyslexic" className="text-sm font-medium flex items-center gap-2 dark:text-slate-200">
                <Type className="w-4 h-4 text-fifa-gold" /> Readable Font
              </label>
              <input
                id="toggle-dyslexic"
                type="checkbox"
            ...
            <div className="flex justify-between items-center">
              <label htmlFor="toggle-voice" className="text-sm font-medium flex items-center gap-2 dark:text-slate-200">
                <Volume2 className="w-4 h-4 text-fifa-emerald" /> Voice Reader
              </label>
              <input
                id="toggle-voice"
                type="checkbox"
          ...
          <div className="mt-3 pt-3 border-t border-slate-200/50 dark:border-white/10 text-[10px] text-slate-400 text-center leading-relaxed">
